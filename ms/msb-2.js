...
$(document).ready(function() {
    ...
    // StepPixel
    var stepPixel = function(page) {
      if (document.cdnParameters.cake_offer_id != '' && typeof document.cdnParameters.cake_offer_id !== "undefined" && steps[page].event != '' && typeof steps[page].event !== "undefined" && document.cdnParameters.lp_tracking_prefix != '' && typeof document.cdnParameters.lp_tracking_prefix !== "undefined") { //REVIEW: Added check for cake_offer_id AND cake_lp_event_id AND lp_tracking_prefix
