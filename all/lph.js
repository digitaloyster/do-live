...
// CSS CDN FILE
const styleLPH=document.createElement('link');
styleLPH.setAttribute('rel', 'stylesheet');
styleLPH.setAttribute('type', 'text/css');
styleLPH.setAttribute('href', '//cdn.jsdelivr.net/gh/digitaloyster/do-live/all/lp.css');
document.getElementsByTagName('head')[0].appendChild(styleLPH);
// CSS CDN FILE
...
if ( typeof document.cdnParameters.postcode !== 'undefined' ) {
  ...
  if (document.cdnParameters.postcode == 'A') {
    (function(n, t, i, r) {
      let u; let f; n[i]=n[i]||{}, n[i].initial={accountCode: 'DIGIT11191', host: 'DIGIT11191.pcapredict.com'}, n[i].on=n[i].on||function() {
