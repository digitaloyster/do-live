...
if (getUrlParameter('awid') != '' && typeof getUrlParameter('awid') !== 'undefined' && getUrlParameter('awcid') != '' && typeof getUrlParameter('awcid') !== 'undefined'){
  if (typeof window.ub.form !== 'undefined') {
      if (window.ub.form.url != '' && typeof window.ub.form.url !== 'undefined'){
          if (window.ub.form.url.indexOf('?') !== -1) window.ub.form.url = window.ub.form.url + "&awid=" + getUrlParameter('awid') + "&awcid=" + getUrlParameter('awcid');
          else window.ub.form.url = window.ub.form.url + "?awid=" + getUrlParameter('awid') + "&awcid=" + getUrlParameter('awcid');
      }
  }
}
// Google Adwords Passthrough
